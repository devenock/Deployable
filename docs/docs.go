    ...
    "paths": {
        ...
        "/account/github/repos/{id}": {
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Set to 'button' to get the re-rendered Add button instead of an empty response",
                        "name": "render",
                        "in": "query"
                    },
                    {
        ...
        "/dashboard": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "'zip', 'github', or 'cli' — filter by source type (Reports section)",
                        "name": "type",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "'attention' (score \u003c 60) or 'ready' (score \u003e= 60) (Reports section)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "'newest' (default), 'oldest', 'score_desc', or 'score_asc' (Reports section)",
                        "name": "sort",
                        "in": "query"
                    },
                    {
        ...
        "/login": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Set to 1 after successful email verification, shows a confirmation notice",
                        "name": "verified",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Set to 1 after a successful password reset, shows a confirmation notice",
                        "name": "reset",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Set to 1 when GitHub/Google sign-in fails or is not configured, shows an error",
                        "name": "oauth_error",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Invalid credentials or unverified email — form re-rendered with error, no session created",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/register": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Validation failed or email already registered — form re-rendered with error",
                        "schema": {
                            "type": "string"
                        }
                    },
